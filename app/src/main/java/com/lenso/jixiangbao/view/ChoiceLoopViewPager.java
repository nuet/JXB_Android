 ...
 */
public class ChoiceLoopViewPager extends JViewPager {
    ...
    public ChoiceLoopViewPager(Context context) {
        super(context);
        this.context = context;
    }

    public ChoiceLoopViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
    }
...
//        count = urls.size();
//        setAdapter(new ChoiceLoopViewPagerAdapter(getContext(), urls));
//        pagerChangeListener();
...
//    public void setPagerAdapter(List<View> viewList){
//        setAdapter(new ChoiceLoopViewPagerAdapter(context, viewList));
//    }
