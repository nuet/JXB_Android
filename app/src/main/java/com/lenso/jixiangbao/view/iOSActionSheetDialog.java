...
/**
 * Created by Chung on 2016/6/27.
 */
public class iOSActionSheetDialog {
    private Context context;
    private Dialog dialog;
    private TextView pop_btn_take_photo;
    private TextView pop_btn_choose_photo;
    ...
    public iOSActionSheetDialog builder() {
        ...
        // 获取自定义Dialog布局中的控件
        pop_btn_take_photo = (TextView) view.findViewById(R.id.pop_btn_take_photo);
